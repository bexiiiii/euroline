...
import { ChevronRight, ShoppingCart, SlidersHorizontal } from "lucide-react";
...
function SearchPage() {
  ...
  const {
    ...
    selectedCatalog,
    setSelectedCatalog,
    loadOemApplicableVehicles,
    loadOemApplicability,
    resetOemFlow,
    filters,
    clearResults,
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start">
            ...
            <section className="w-full lg:w-3/4">
              {isOem &&
                ...
                filteredPrimarySearchResults.length === 0 && (
                <div className="rounded-lg border overflow-hidden mb-4">
                    ...
                    {applicableVehicles.map((v, idx) => (
                      ...
                      >
                        <div className="flex items-center px-4 py-3">
                          <div className="w-1/4 font-semibold uppercase text-gray-900 truncate">
                  ...
                  <div className="px-4 py-2 bg-white border-t flex justify-between items-center">
                    <p className="text-sm text-gray-500">
                      Найдено вариантов: {applicableVehicles.length}
                    </p>
                    <button
