...
export function UpgradeBanner({
    ...
    <div className={cn("mx-auto flex items-center justify-center", className)}>
      <AnimatePresence>
        ...
        >
          ...
          >
            <SettingsFilled className="text-[#f2b500] dark:text-[#006EFE]" />
          </motion.div>
          <div className="relative flex h-[35px] items-center gap-1 rounded-[6px] border border-[#CBE7FF] bg-[#F0F7FF] pl-2.5 pr-1 text-sm dark:border-[#003674] dark:bg-[#06193A]">
            ...
            <span className="text-[0.8125rem] text-[#f2b500] dark:text-[#44A7FF]">
              {description}
            </span>
  ...
  >
    <X size={16} className="text-[#f2b500] dark:text-[#47A8FF]" />
  </button>
)}
          </div>
        </motion.div>
