...
ALTER TABLE cml_orders
    ...
    ADD COLUMN IF NOT EXISTS customer_middle_name VARCHAR(255),
    ADD COLUMN IF NOT EXISTS customer_state VARCHAR(255),
    ADD COLUMN IF NOT EXISTS customer_type VARCHAR(255),
    ADD COLUMN IF NOT EXISTS customer_office_address VARCHAR(500),
