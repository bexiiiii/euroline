...
interface MarketingToolbarProps {
  ...
  onExportClick?: (range: ExportDateRange) => Promise<void> | void;
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          {showExportButton && !actions && onExportClick && (
            <ExportWithDateRange
              triggerLabel="Экспорт"
              variant="outline"
              size="sm"
              onConfirm={onExportClick}
              title="Экспорт маркетинговых данных"
              description="Укажите период для выгрузки отчета в CSV."
              icon={
